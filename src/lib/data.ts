...
export const calendarEvents = [
  ...
  // July 26, 2025 - Saturday
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 6, 26, 8, 0),
    end: new Date(2025, 6, 26, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 6, 26, 9, 0),
    end: new Date(2025, 6, 26, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 6, 26, 10, 0),
    end: new Date(2025, 6, 26, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 6, 26, 11, 0),
    end: new Date(2025, 6, 26, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 6, 26, 13, 0),
    end: new Date(2025, 6, 26, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 6, 26, 14, 0),
    end: new Date(2025, 6, 26, 14, 45),
  },
];
